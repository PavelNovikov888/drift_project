...
Демонстрация здесь ./drift_project/picture/port8000
- http://localhost:9090/targets В колонке "endpoint" напротив строки http://drift:8000/metrics долшна быть зелёная пометка UP   
Демонстрация здесь ./drift_project/picture/port9090.png  
...
Демонстрация ./drift_project/picture/datasourse3000.png  
...
Демонстрация ./drift_project/picture/save_test3000.png  
...
Демонстрация ./drift_project/picture/dashboard3000.png
